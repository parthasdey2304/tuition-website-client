  ...
  return (
    <div className="space-y-16">
      ...
      <section className="relative">
        <div className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/centers" className="btn bg-white text-blue-600 border border-blue-600 hover:bg-blue-50 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-blue-500 dark:text-blue-400 text-lg px-8 py-3">
              Find Nearby Centers
            </Link>
          </div>
        </div>
        
        <div className="absolute inset-0 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-900 -z-10"></div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Why Choose TuitionHub?</h2>
