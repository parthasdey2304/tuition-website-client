...
function Register() {
  ...
  const handleTruecallerSignup = () => {
    setError('Truecaller signup functionality is not implemented yet.')
  }
  
  return (
    <div className="max-w-md mx-auto py-2 font-['Poppins'] min-h-[100vh] flex flex-col justify-between px-8">
      <div className="flex-1 pt-10 md:pt-28">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-blue-900 dark:text-blue-300">Create an Account</h1>
          <p className="text-blue-600 dark:text-blue-400 mt-2">Join us and start your learning journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card mb-6 mt-8">
          ...
          <div className="mb-6">
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-blue-700 dark:text-blue-300 mb-1">
              Confirm Password
            </label>
            <input 
              type="password" 
        ...
        <p className="text-center text-xs text-blue-500 dark:text-blue-400 mt-4">
