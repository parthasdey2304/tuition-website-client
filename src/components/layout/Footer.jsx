      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/courses" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Courses</Link></li>
              <li><Link to="/teachers" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Teachers</Link></li>
              <li><Link to="/centers" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Centers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400">Study Materials</a></li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-6 flex justify-between">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            &copy; {currentYear} TuitionHub. All rights reserved.
          </p>
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Privacy Policy</a> | 
            <a href="#" className="hover:text-blue-600 dark:hover:text-blue-400 ml-3">Terms of Service</a>
          </p>
        </div>
      </div>
    </footer>
